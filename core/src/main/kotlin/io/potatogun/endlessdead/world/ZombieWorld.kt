 ...
 */
class ZombieWorld : World(Constants.ZOMBIE_WORLD_WIDTH, Constants.ZOMBIE_WORLD_HEIGHT, World.Properties().entityManager(SpatialHashGrid(128f))), Freezable, SinglePlayerWorld {
	/**
	 * 플레이어 — 월드 중앙에서 시작.
	 */

 ...
 */
class Chest(world: World, position: Position, initialItem: Item? = null): Container(world, position, 24f, 25f, Textures.getShared("chest"), Textures.getShared("empty_chest"), initialItem) {
